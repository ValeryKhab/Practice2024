...
from data_generator import NModule
from data_generator import input_num
from VoteAlgorithm import VoteAlgorithm
...
def generate_data(modules_list: list, current_module_index: int, experiments_names_list: list):
    ...
    generate_data = modules_list[
        current_module_index].generate_experiment_data(
...
def load_experiment_data(modules_list: list, current_module_index: int, experiments_names_list: list):
    if len(experiments_names_list) == 0:
        ...
        experiments_names_list = modules_list[
            current_module_index].get_experiments_names()
...
def main():
    ...
    while (user_chosen_item := get_choice()) != MenuOption.EXIT:
        if user_chosen_item == MenuOption.ADD_MODULE:
            ...
            modules_list.append(NModule('NoName', 6).load_module())
            ...
            if check_var_is_not_none(current_module_index, ""):
                ...
                modules_list.append(NModule('NoName', 6).load_module_with_versions())
